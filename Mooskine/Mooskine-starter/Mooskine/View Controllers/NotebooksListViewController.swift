...
//        fetchedResultsController = nil
    ...
    fileprivate func setupListDataSource() {
        ...
        listDataSource = ListDataSource(tableView: tableView, managedObjectContext: dataController.viewContext, fetchRequest: fetchRequest, configure: { (cell, notebook) in
